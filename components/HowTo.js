      ...
      <div className="container">
        ...
        <div>
          <HowToCode number="1" title="Add enami.js script">
            &lt;<span className="red">script</span> <span className="green">src</span>=&quot;<span className="yellow">https://unpkg.com/enami@latest/dist/index.js</span>&quot;&gt;&lt;/<span className="red">script</span>&gt;
          </HowToCode>
